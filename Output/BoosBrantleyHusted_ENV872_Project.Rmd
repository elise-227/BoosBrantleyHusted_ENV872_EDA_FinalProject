...
NewRiver.Discharge.PROC$Date <- as.Date(NewRiver.Discharge.PROC$datetime, format = '%m/%d/%y')
...
```{r, NY time series analysis, echo=FALSE, fig.cap= "Decomposed Components of the New York Discharge Time Series"}
...
```{r NY time series analysis, echo=FALSE, fig.cap= "Nonseasonal Data from the New York Discharge Time Series"}
...
```{r, NC time series analysis, echo=FALSE, fig.cap= "Decomposed Components of the North Carolina Discharge Time Series"}
...
```{r NC time series analysis, echo=FALSE, fig.cap= "Nonseasonal Data from the North Carolina Discharge Time Series"}
...
```{r FL analysis time series, echo=FALSE, fig.cap= "Decomposed plot of Florida discharge time series"}
#regular time series
...
```{r FL analysis remove seasonal, echo=FALSE, fig.cap= "Nonseasonal data from Florida discharge time series"}
...
Above is a plot of the non seasonal data in the Florida time series which was determined by removing the seasonal data from the time series. 

```{r FL analysis trend and final plot, echo=FALSE, fig.cap="Plot of nonseasonal time series of Florida discharge and overall trend"}
