...
- Exploratory Analysis                                          
   Figure \ref{fig:plot} Florida Mean Daily Discharge During Hurricane Season                 
...
Figure fig:ex-an-FL is an initial plot of discharge within hurricane months at the Florida location and shows a potential decrease in discharge over time. 

```{r ex-an-FL, warning=FALSE, echo=FALSE, message=FALSE, fig.align='center', fig.cap = "Florida Discharge (cfs) 1990-2021\\labelfig:plot"}
...
The following plot (Figure fig:ex-an-NC) for the North Carolina daily discharge dataset displays a potential increasing trend over time.
