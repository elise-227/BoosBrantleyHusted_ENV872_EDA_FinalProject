...
Above is the decomposed time series of the New York discharge data during hurricane months. 
...
The plot above displays the non-seasonal data in the New York time series which was produced by removing the seasonal component from the time series. 
