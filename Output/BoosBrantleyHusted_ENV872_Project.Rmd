...
- Table 2. List of tau and p-values from time series analyses

\newpage

## List of Figures
- Exploratory Analysis
  - Figure 1. Florida Mean Daily Discharge During Hurricane Season
  - Figure 2. North Carolina Mean Daily Discharge During Hurricane Season
  - Figure 3. New York Mean Daily Discharge During Hurricane Season
- Analysis
  - Figure 4. Decomposed Components of New York Time Series
  - Figure 5. New York Non-Seasonal Daily Discharge During Hurricane Season
  - Figure 6. Decomposed Components of North Carolina Time Series
  - Figure 7. North Carolina Non-Seasonal Daily Discharge During Hurricane Season
  - Figure 8. Decomposed Components of Florida Time Series
  - Figure 9. Florida Non-Seasonal Daily Discharge During Hurricane Season
  - Figure 10. Comparison Between Three Sites: Non-Seasonal Daily Discharge During Hurricane Season
...
Table 1. Table summarizing the dataset structure.
...
An initial plot of discharge within hurricane months at the Florida location shows a potential decrease in discharge over time (Fig. 1). 

```{r ex an FL, warning=FALSE, echo=FALSE, message=FALSE, fig.align='center',fig.cap='Figure 1. Florida Discharge (cfs) 1990-2021'}
...
The following plot for the North Carolina daily discharge dataset displays a potential increasing trend over time (Fig. 2).

```{r ex an NC, warning=FALSE, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Figure 2. North Carolina Discharge (cfs) 1990-2021'}
...
The following plot for the New York daily discharge dataset displays a potential increasing trend over time (Fig. 3).

```{r ex NY, warning=FALSE, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Figure 3. New York Discharge (cfs) 1990-2021'}
...
The following plot displays the decomposed daily discharge components of the time series run on the New York dataset during hurricane season (Fig. 4).

```{r, NY time series analysis, warning=FALSE, echo=FALSE, fig.align='center', fig.cap= "Figure 4. Decomposed Components of the New York Discharge Time Series"}
...
The plot below displays the non-seasonal daily discharge data in the New York time series which was produced by removing the seasonal component from the time series (Fig. 5). 

```{r NY time series analysis continued, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap= "Figure 5. Nonseasonal Data from the New York Discharge Time Series"}
...
```{r, NC time series analysis, echo=FALSE, warning=FALSE, fig.align='center', fig.cap= "Figure 6. Decomposed Components of the North Carolina Discharge Time Series"}
...
Above is the decomposed time series of the North Carolina discharge data during hurricane months (Fig. 6). The Mann Kendall Test yielded a tau value of 0.0572 and a 2-sided p value of =< 2.22e-16.

```{r NC time series analysis cont, warning=FALSE, message=FALSE, fig.align='center', echo=FALSE, fig.cap= "Figure 7. Nonseasonal Data from the North Carolina Discharge Time Series"}
...
The plot above displays the non-seasonal data in the North Carolina time series which was produced by removing the seasonal component from the time series (Fig. 7). 

### Florida Analysis

Seen below is the decomposed time series of the Florida discharge data during hurricane months (Fig. 8). 

```{r FL analysis time series, echo=FALSE, warning=FALSE, fig.align='center', fig.cap= "Figure 8. Decomposed plot of Florida discharge time series"}
#regular time series
...
Each of the locations non-seasonal time series and trends are visualized and compared in the figure below (Fig. 10). The color patterns are the same as above with Florida in pink, North Carolina in green, and New York in turquoise.  

```{r combined plot, warning=FALSE, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Figure 10. Non-Seasaonl Discharge Plot for all Gage Sites (cfs)'}
...
Table 2. List of tau values and p-values from non-seasonal time series analyses. 
